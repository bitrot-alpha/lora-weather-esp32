...
### Current Features
* Atmospheric conditions (Bosch BME280)
  * Temperature - +/-0.5C
  * Relative Humidity - +/- 3% (sadly is not intended for condensing environment - reading stuck at 100% after ~1 year of runtime, so this is going to be the job of an SHT31 soon)
  * Barometric Pressure
* Wind Speed & Direction (anemometer, 16 direction weather vane)
...
* Add SHT31 sensor for more accurate humidity data. The BME280 is not designed for "condensing" environments (don't get it wet..)
